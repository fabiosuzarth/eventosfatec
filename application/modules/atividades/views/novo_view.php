                                    ...
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">
                                                <i class="fa fa-fw fa-file-text-o"></i> Cadastrar Atividade
                                            </h3>
                                                ...
                                                <div class="col-md-4">
                                                            ...
                                                            <label for="evento">Evento</label>
                                                                <select class="form-control" name="evento_id" id="evento_id">
                                                                    ...
                                                                    <?php foreach ($evento as $evt) { ?>
                                                                        <option value="<?php echo $evt->id ?>"><?php echo $evt->nome ?></option>
                                                                   <?php } ?>
                                                            ...
                                                            <label for="evento">Palestrante</label>
                                                                <select class="form-control" name="palestrante_id" id="palestrante_id">
                                                                    ...
                                                                    <?php foreach ($palestrante as $pale) { ?>
                                                                        <option value="<?php echo $pale->id ?>"><?php echo $pale->nome ?></option>
                                                                   <?php } ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class='box-body'>
                                                                <textarea class="textarea editor-cls" name="descricao" placeholder="Descrição"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                   ...
                                                   <br>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="vagas" name="vagas" placeholder="Vagas">
                                                        </div>
                                                    </div>
